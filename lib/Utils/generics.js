...
exports.bytesToCrockford = exports.trimUndefined = exports.isWABusinessPlatform = exports.getCodeFromWSError =
exports.getCallStatusFromNode = exports.getErrorCodeFromStreamError = exports.getStatusFromReceiptType =
exports.generateMdTagPrefix = exports.fetchLatestWaWebVersion = exports.fetchLatestBaileysVersion =
exports.printQRIfNecessaryListener = exports.bindWaitForConnectionUpdate = exports.bindWaitForEvent =
exports.generateMessageID = exports.generateMessageIDV2 = exports.promiseTimeout = exports.delayCancellable =
exports.delay = exports.debouncedTimeout = exports.unixTimestampSeconds = exports.toNumber =
exports.encodeBigEndian = exports.generateRegistrationId = exports.encodeWAMessage = exports.unpadRandomMax16 =
exports.writeRandomPadMax16 = exports.getKeyAuthor = exports.BufferJSON = exports.Browsers = void 0
...
exports.Browsers = browser => {
    const osName = PLATFORM_MAP[(0, os_1.platform)()] || "Ubuntu"
...
const encodeWAMessage = message => (
    writeRandomPadMax16(WAProto_1.proto.Message.encode(message).finish())
)
...
const fetchLatestWaWebVersion = async (options = {}) => {
    try {
        ...
        const response = await (0, fetch_1.default)("https://web.whatsapp.com/sw.js", {
            method: "GET",
            headers
        })
        if (!response.ok) {
        ...
        if (!match || !match[1]) {
            return { version: baileysVersion, isLatest: false, error: { message: "Client revision not found" } }
        }
...
const getCallStatusFromNode = ({ tag, attrs }) => {
    ...
    switch (tag) {
        ...
        case "offer_notice":
            ...
            break
        case "terminate":
            status = attrs.reason === "timeout" ? "timeout" : "reject"
            break
        case "reject":
            status = "reject"
            break
